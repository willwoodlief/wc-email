...
<div class="wrap woo_email_customizer_settings_con">
    ...
    <div class="woo_email_customizer_settings_nav_con" id="email-builder">
        <ul class="nav nav-tabs">
            <li<?php echo ($settings_page == 'default')? ' class="active"': ''; ?>><a href="<?php echo admin_url("admin.php?page=woo_email_customizer_page_builder&settings=default"); ?>">General</a></li>
            <li<?php echo ($settings_page == 'reset_template')? ' class="active"': ''; ?>><a href="<?php echo admin_url("admin.php?page=woo_email_customizer_page_builder&settings=reset_template"); ?>">Reset templates</a></li>
            <li<?php echo ($settings_page == 'template_options')? ' class="active"': ''; ?>><a href="<?php echo admin_url("admin.php?page=woo_email_customizer_page_builder&settings=template_options"); ?>">Enable/Disable template</a></li>
        </ul>
        <div class="clear"></div>
